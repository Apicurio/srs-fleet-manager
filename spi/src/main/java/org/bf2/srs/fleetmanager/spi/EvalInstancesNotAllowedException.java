 ...
 */
public class EvalInstancesNotAllowedException extends Exception implements UserError {

    private static final long serialVersionUID = 1533950326352789373L;

    public EvalInstancesNotAllowedException() {
        super();
    }
    ...
    public UserErrorInfo getUserErrorInfo() {
        return UserErrorInfo.create(UserErrorCode.ERROR_EVAL_INSTANCES_NOT_ALLOWED);
    }
}
