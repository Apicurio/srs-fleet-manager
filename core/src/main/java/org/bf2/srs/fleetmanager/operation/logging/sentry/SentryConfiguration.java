...
package org.bf2.srs.fleetmanager.operation.logging.sentry;
...
import org.bf2.srs.fleetmanager.FleetManagerSystem;
...
public class SentryConfiguration {
    ...
    @ConfigProperty(name = "srs-fleet-manager.enable.sentry", defaultValue = "false")
    Boolean enableSentry;

    @Inject
    FleetManagerSystem system;
